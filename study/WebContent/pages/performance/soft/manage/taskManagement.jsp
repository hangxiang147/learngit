	...
	<div class="container-fluid">
      <div class="row">
      		...
      		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      			<h3 class="sub-header" style="margin-top:0px;">查看任务</h3> 
      			<form id="searchTask" action="/performance/soft/showAllTaskByConditions" class="form-horizontal">
      		...
      		<div class="form-group">
      			...
      			<div class="form-group">
      				...
      				<div class="col-sm-2">
      					<input autoComplete="off" name="functionVo.name" class="form-control" value="${functionVo.name}">
					</div>
					<div class="col-sm-1">
	              ...
	              <tbody>
	              	<c:forEach items="${taskLst}" var="task" varStatus="index">
	              		...
	              		<td>
	              			...
	              			<c:when test="${task.instanceId == 'null'}">
	              				任务未开始
	              			</c:when>
	              			<c:otherwise>
	              				进行中
	              		...
	              		<td>
	              			...
	              			<a onclick="goPath('/performance/soft/showTaskDetail?taskId=${task.id}&instanceId=${task.instanceId}&isFromManage=1')" href="javascript:void(0)">
...
/*      		$(".pager li a,.limit li a").each(function(){
    			$(this).click(function(){
    				...
    				if(href.indexOf("showAllTaskByConditions")!=-1){
    	...
    	function endTask(instanceId){
    		$.post('/performance/soft/endSoftTask?instanceId='+instanceId,function(){
    			location.reload();
    			Load.Base.LoadingPic.FullScreenShow(null);
    			//window.location.href = "performance/soft/showTask";
    		})
    	}
  </script>
</body>
