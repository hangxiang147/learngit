	...
	<div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	<form action="personal/save_startFormal" method="post" class="form-horizontal" onsubmit="return check()">
        	  <s:token></s:token>
        	  <h3 class="sub-header" style="margin-top:0px;">转正申请</h3> 
        	  <!-- 填写转正申请的操作人 -->
			  <input type="hidden" id="userID" name="formalVO.userID" value="${user.id}"/>
			  <input type="hidden" id="userName" name="formalVO.userName" value="${staff.lastName }" />
			  <!-- 转正人 -->
			  <input type="hidden" id="requestUserID" name="formalVO.requestUserID" value="${user.id }"/>
   			  <input type="hidden" id="requestUserName" name="formalVO.requestUserName" value="${staff.lastName }"/>
