	...
	<div class="container-fluid">
      <div class="row">
       ...
       <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <form  id="form_" class="form-horizontal" action="/personal/newChopBorrow">     	  
            ...
            <table class="table table-striped">
              ...
              <tbody>
              	...
              	<c:forEach items="${chops}" var="item" varStatus="index">
              		...
              		<td>
            			<input class="btn btn-primary" value="申请公章" onClick="new_task_for_chopBorrow('${item.chop_Id}')" style="width:100px"/>
              		</td>
              		</tr>
              	</c:forEach>
              	</c:if>
         ...
         var  new_task_for_chopBorrow=function (id){
        	 location.href="/personal/toBeginChopBorrowPage?id="+id;
         }
          </script>
        </div>
      </div>
