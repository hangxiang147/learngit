			  ...
			  <div class="form-group" id="beginDate_div">
	    		...
	    		<div class="col-sm-2">
	    			<input type="text" class="form-control" id="beginDate" name="vacationVO.beginDate"
	    			 required="required" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'endDate\')}'})" onBlur="calcTime(),autoEndDate(),checkAnnualVacation(),checkMarriageHoliday()" />
	    	  ...
	    	  <div class="form-group" id="endDate_div">
	    		...
	    		<div class="col-sm-2">
	    			<input type="text" class="form-control" id="endDate" name="vacationVO.endDate"
	    			 required="required" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" onBlur="calcTime(),checkAnnualVacation(),checkMarriageHoliday()"/>
