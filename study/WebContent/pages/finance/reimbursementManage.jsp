...
<script type="text/javascript">
	...
	function search() {
		...
		window.location.href = "finance/reimbursement/findReimbursementList?" +encodeURI(encodeURI(decodeURIComponent(params,true)));
      ...
      <div class="row">     	
        ...
        <form id="queryReimbursementForm" class="form-horizontal">
       	  ...
       	  <div class="form-group">
			    ...
			    <label for="reimbursementName" class="col-sm-1 control-label">报销人</label>
			    <div class="col-sm-2">
              ...
              <tbody>
              	...
              	<s:iterator id="reimbursementVO" value="#request.reimbursementList" status="count">
              		<tr>
              			...
              			<td class="col-sm-2">
              			<a onclick="goPath('finance/reimbursement/getReimbursementDetail?processInstanceID=<s:property value='#reimbursementVO.processInstanceID'/>')" href="javascript:void(0)">
              			<svg class="icon" aria-hidden="true" title="查看报销单详情" data-toggle="tooltip">
    						<use xlink:href="#icon-Detailedinquiry"></use>
						</svg>
              			</a>
              			&nbsp;
              			<a onclick="goPath('finance/reimbursement/getReimbursementProcess?processInstanceID=<s:property value='#reimbursementVO.processInstanceID'/>')" href="javascript:void(0)">
