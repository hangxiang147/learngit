      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	<form class="form-horizontal">
        	  <h3 class="sub-header" style="margin-top:0px;">报销单详情</h3>
			    <div class="Cost">
        		<div id="printArea">
				<div class="Costlm"><span>费　用　报　销　单</span></div>
				<div class="unit"><span class="fl">报销部门：<em>${departmentName }（${companyName }）</em></span><span class="fl">报销单号：<em>${reimbursementVO.reimbursementNo }</em></span><span class="fr">报销日期：<em>${reimbursementVO.requestDate.split(" ")[0] }</em></span></div>
				<div class="Cost_tab">
				...
				<div class="Cost_foot"><span>会计主管：<em>${reimbursementVO.showPerson2}</em></span><span>会计：<em>${reimbursementVO.showPerson1}</em></span><span>出纳：<em>${reimbursementVO.showPerson3}</em></span><span>报销人：<em>${reimbursementVO.requestUserName }</em></span><span>领款人：<em>${reimbursementVO.payeeName }</em></span></div>				
				</div>
