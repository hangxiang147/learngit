  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">     	
        ...
        <s:set name="selectedPanel" value="'paymentList'"></s:set>    
        <%@include file="/pages/administration/panel.jsp" %>		
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       
        <form id="queryReimbursementForm" class="form-horizontal" action="/administration/process/findUserPaymentList" onsubmit="Load.Base.LoadingPic.FullScreenShow(null)">
              ...
              <tbody>
              	...
              	<s:iterator id="reimbursementVO" value="#request.reimbursementList" status="count">
              		<tr>
              			...
              			<a onclick="goPath('finance/reimbursement/getPaymentDetail?type=1&processInstanceID=<s:property value='#reimbursementVO[0]'/>')" href="javascript:void(0)">
              			<svg class="icon" aria-hidden="true" title="查看付款单详情" data-toggle="tooltip">
    						<use xlink:href="#icon-Detailedinquiry"></use>
						</svg>
              			</a>
              			&nbsp;
              			<a onclick="goPath('finance/reimbursement/getReimbursementProcess?type=3&processInstanceID=<s:property value='#reimbursementVO[0]'/>')" href="javascript:void(0)">
