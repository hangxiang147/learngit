  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">     	
        ...
        <s:set name="selectedPanel" value="'ReimbursementList'"></s:set>    
        <%@include file="/pages/administration/panel.jsp" %>		
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       
        <form id="queryReimbursementForm" class="form-horizontal" action="/administration/process/findUserReimbursementList" onsubmit="Load.Base.LoadingPic.FullScreenShow(null)">
       	  <h3 class="sub-header" style="margin-top:0px;">报销列表</h3>
       	  <div class="form-group" style="margin-top:10px">
				<label for="beginDate" class="col-sm-1 control-label">报销单号</label>
				<div class="col-sm-2">
			    	<input type="text" class="form-control" id="No_code" name="code" value="${code}" placeholder="报销编号">
			    </div>
              ...
              <tbody>
              	...
              	<s:iterator id="reimbursementVO" value="#request.reimbursementList" status="count">
              		<tr>
              			...
              			<a onclick="goPath('finance/reimbursement/getReimbursementDetail?type=1&processInstanceID=<s:property value='#reimbursementVO[0]'/>')" href="javascript:void(0)">
              			<svg class="icon" aria-hidden="true" title="查看报销单详情" data-toggle="tooltip">
    						<use xlink:href="#icon-Detailedinquiry"></use>
						</svg>
              			</a>
              			&nbsp;
              			<a onclick="goPath('finance/reimbursement/getReimbursementProcess?type=1&processInstanceID=<s:property value='#reimbursementVO[0]'/>')" href="javascript:void(0)">
