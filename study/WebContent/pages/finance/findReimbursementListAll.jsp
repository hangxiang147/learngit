...
<script type="text/javascript">
	...
	function search() {
		...
		window.location.href = "/finance/process/findReimbursementListAll?" + params;
      ...
      <div class="row">
        ...
        <form id="queryReimbursementForm" class="form-horizontal">
       	  ...
       	  <div class="form-group">
			    ...
			    <div class="col-sm-2">
			    	<input type="text" class="form-control" id="demandName" name="demandName" value="${demandName }" >
			    </div>
		  </div>
		  <div class="form-group">
              ...
              <tbody>
              	...
              	<s:iterator id="taskVO" value="#request.taskVOs" status="count">
              		<tr>
              			...
              			<td class="col-sm-1">
              			<a href="finance/process/auditReimbursement?taskID=<s:property value='#taskVO.taskID' />&selectedPanel=reimbursementList&isFromAll=1&taskName=<s:property value="#taskVO.taskName"/>">
