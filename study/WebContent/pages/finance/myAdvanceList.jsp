    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<h3 class="sub-header" style="margin-top:0px;">预约付款申请列表</h3>
	              ...
	              <thead>
	                <tr>
	              	...
	              	<s:iterator id="reimbursementVO" value="#request.reimbursementVOs" status="count">
	              		<tr>
	              			<td style="width:5%"><s:property value="#reimbursement_id+1"/></td>
	              			<td class="col-sm-1"><a onclick="goPath('finance/process/processHistory?type=1&processInstanceID=<s:property value='#reimbursementVO.processInstanceID'/>')" href="javascript:void(0)"><s:property value="#reimbursementVO.title"/></a></td>
	              			...
	              			<td class="col-sm-1">
	              				<a onclick="goPath('finance/reimbursement/getAdvanceDetail?type=5&processInstanceID=<s:property value='#reimbursementVO.processInstanceID'/>&selectedPanel=myAdvanceList')" href="javascript:void(0)">
