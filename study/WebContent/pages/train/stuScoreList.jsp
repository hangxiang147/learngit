    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <form action="train/stuScoreList" class="form-horizontal" onsubmit="Load.Base.LoadingPic.FullScreenShow(null)">
            ...
            <table class="table table-striped">
              <thead>
                <tr>
                  ...
                  <th style="width:10%">学员名字</th>
                  <th style="width:10%">得分</th>
                </tr>
              </thead>
              <tbody>
              	<c:forEach items="${stuScoreList}" var="stuScore" varStatus="status">
              		<tr>
