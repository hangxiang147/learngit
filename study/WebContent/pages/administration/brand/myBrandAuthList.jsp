              		  ...
              		  <tbody>
		              	...
		              	<c:forEach items="${brandAuthVos}" var="item" varStatus="index">
		              		<tr>
			              		...
			              		<td>${item.status}</td>
			              		<td>
			              		<a onclick="goPath('administration/process/processHistory?processInstanceID=${item.processInstanceID}&selectedPanel=myBrandAuthList')" href="javascript:void(0)">
			              			<svg class="icon" aria-hidden="true" title="查看流程详情" data-toggle="tooltip">
             							<use xlink:href="#icon-liucheng"></use>
             						</svg>
			              		</a>
			              		&nbsp;
			              		<a onclick="goPath('administration/process/showBrandAuthDetail?processInstanceID=${item.processInstanceID}&selectedPanel=myBrandAuthList')" href="javascript:void(0)">
