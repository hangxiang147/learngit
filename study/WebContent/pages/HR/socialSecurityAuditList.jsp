    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       	  <h3 class="sub-header" style="margin-top:0px;">社保缴纳审核列表</h3>
              ...
              <tbody>
              	...
              	<s:iterator id="taskVO" value="#request.taskVOs" status="count">
              		<tr>
              			...
              			<td class="col-sm-1">
              			<s:if test="#taskVO.taskDefKey == 'ssHRUpdate'" >
              			<a onclick="goPath('HR/process/updateSocialSecurity?taskID=<s:property value='#taskVO.taskID' />')" href="javascript:void(0)">
              			<svg class="icon" aria-hidden="true" title="修改" data-toggle="tooltip">
							<use xlink:href="#icon-modify"></use>
						</svg>
              			</a>
              			</s:if>
              			<s:if test="#taskVO.taskDefKey == 'ssFollowUp'" >
              			<a onclick="goPath('HR/process/updateSocialSecurity?taskID=<s:property value='#taskVO.taskID' />')" href="javascript:void(0)">
              			<svg class="icon" aria-hidden="true" title="跟进" data-toggle="tooltip">
