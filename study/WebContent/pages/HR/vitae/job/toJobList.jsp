...
.float_div{
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row"> 
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <form  id="form_" class="form-horizontal" action="/HR/vitae/toJobList">     	  
          	<h3 class="sub-header" style="margin-top:0px;">应聘职位信息管理</h3> 
			   <div class="form-group" >
			  	<label for="reason" class="col-sm-1 control-label">职位名称</label>
           ...
           <a class="btn btn-primary"  href="/HR/vitae/toJobAddList"><span class="glyphicon glyphicon-plus"></span> 标准职位</a>
            ...
            <table class="table table-striped">
              <thead>
                <tr>
                  ...
                  <th class="col-sm-1">预设面试官</th>
                  <th class="col-sm-1">技术面试官</th>
              ...
              <tbody>
              	...
              	<c:forEach items="${resultList}" var="item" varStatus="index">
              		...
              		<td>${item.jobName }</td>
              		<td>${item.subjectPersonNames }</td>
              		<td>${item.technologySubjectPersonNames }</td>
              		<td>
              		<a onclick="goPath('/HR/vitae/toJobViewList?id=${item.id}')" href="javascript:void(0)">	
             			<svg class="icon" aria-hidden="true" title="查看" data-toggle="tooltip">
						    <use xlink:href="#icon-Detailedinquiry"></use>
						</svg>
              		</a>
              		&nbsp;
              		<a onclick="goPath('/HR/vitae/toJobAddList?id=${item.id}')" href="javascript:void(0)">	
             			<svg class="icon" aria-hidden="true" title="编辑" data-toggle="tooltip">
						    <use xlink:href="#icon-modify"></use>
						</svg>
              		</a>
              		&nbsp;
              		<a href="Javascript:fndelete('${item.id}')">	
    ...
    var fndelete=function(id){
    	layer.confirm('是否确认删除？', {
    		  btn: ['确认','取消']
    		},function(){
    			location.href='/HR/vitae/deleteJob?id='+id;
    		});
