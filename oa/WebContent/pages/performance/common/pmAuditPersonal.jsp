...
<script type="text/javascript">
	function completeTask(result){
		...
		location.href = "administration/performance/pmAuditPersonal?result="+result+"&comment="+comment+"&taskId="+taskId;
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       	  <h3 class="sub-header" style="margin-top:0px;">绩效方案明细</h3> 
       	   ...
       	   <div style="margin-left:5%">姓名：<span>${staffName}</span></div>
