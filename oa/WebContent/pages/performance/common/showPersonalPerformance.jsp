	...
	<div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       	  <h3 class="sub-header" style="margin-top:0px;">个人月度绩效考核明细<button style="float:right" class="btn btn-default" onclick="history.go(-1)">返回</button></h3>
