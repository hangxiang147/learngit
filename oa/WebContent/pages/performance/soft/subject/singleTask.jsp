				...
				<label for="associatedRequire" class="col-sm-1 control-label">关联需求</label>
      			...
      			<div class="form-group">
      				...
      				<div id="name" class="col-sm-8">
						<input name="softPerformanceVo.name" autocomplete="off" required="required" value="${softPerformanceVo.name}" class="form-control"/>
					</div>
      			</div>
      			<div class="form-group">
					...
					<label for="estimatedTime" class="col-sm-1 control-label">工时</label>
      				<div id="estimatedTime" class="col-sm-2">
						<input type="number" autocomplete="off" min=0 name="softPerformanceVo.estimatedTime" value="${softPerformanceVo.estimatedTime}" placeholder="小时" class="form-control"/>
					</div>
					<label for="score" class="col-sm-1 control-label">分值</label>
      				<div id="score" class="col-sm-2">
						<input required="required" autocomplete="off" type="number" min=0 max=100 name="softPerformanceVo.score" value="${softPerformanceVo.score}" class="form-control"/>
					</div>
      			</div>
      			<div class="form-group">
