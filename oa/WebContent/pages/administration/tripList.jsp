              ...
              <tbody>
              	...
              	<s:iterator id="taskVO" value="#request.taskVOs" status="count">
              		<tr>
              			...
              			<td class="col-sm-3">
              			<a onclick="goPath('administration/process/auditTask?taskID=<s:property value='#taskVO.taskID' />&selectedPanel=tripList&taskName=<s:property value="#taskVO.taskName"/>')" href="javascript:void(0)">
