        ...
        <%@include file="/pages/administration/panel.jsp" %>
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form id="saveProjectInfo" action="/administration/vehicle/save_saveVehicle"
					...
					<s:token></s:token>
					<input type="hidden" name="vehicleVo.id" value="${vehicleVo.id}">
					<input type="hidden" name="vehicleVo.addTime" value="${vehicleVo.addTime}">
					<input type="hidden" name="vehicleVo.insuranceHandle" value="${vehicleVo.insuranceHandle}">
					<input type="hidden" name="vehicleVo.inspectionHandle" value="${vehicleVo.inspectionHandle}">
					<input type="hidden" name="vehicleVo.insuranceSendMsg" value="${vehicleVo.insuranceSendMsg}">
					<input type="hidden" name="vehicleVo.inspectionSendMsg" value="${vehicleVo.inspectionSendMsg}">
					<table id="vehicleInfo">
						<tbody>
							...
							<tr>
								...
								<td style="width:25%">
									<input class="form-control" autocomplete="off" required name="vehicleVo.licenseNumber" value="${vehicleVo.licenseNumber}" maxLength="50">
								</td>
								<td style="width:25%">品牌<span style="color:red"> *</span></td>
								<td style="width:25%">
									<input class="form-control" autocomplete="off" required name="vehicleVo.brand" value="${vehicleVo.brand}" maxLength="50">
								</td>
							</tr>
							<tr>
								<td>车辆所有人<span style="color:red"> *</span></td>
								<td>
									<input class="form-control" id="vehicleOwner" type="text" autocomplete="off" 
									required name="vehicleVo.ownerName" value="${vehicleVo.ownerName}" maxLength="50">
								</td>
								<td>车架号</td>
								<td>
									<input class="form-control" autocomplete="off" name="vehicleVo.frameNumber" value="${vehicleVo.frameNumber}" maxLength="50">
								</td>
							</tr>
							<tr>
								<td>使用性质</td>
								<td>
									<input class="form-control" autocomplete="off" name="vehicleVo.useProperty" value="${vehicleVo.useProperty}" maxLength="50">
								</td>
								<td>发动机号</td>
								<td>
									<input class="form-control" autocomplete="off" name="vehicleVo.engineNumber" value="${vehicleVo.engineNumber}" maxLength="50">
								</td>
							</tr>
							<tr>
								<td>核定载重量</td>
								<td>
									<input class="form-control" autocomplete="off" name="vehicleVo.deadWeight" value="${vehicleVo.deadWeight}" maxLength="50">
								</td>
								<td>车辆负责人<span style="color:red"> *</span></td>
								<td>
									<input class="form-control" id="vehicleLeader" type="text" autocomplete="off" onkeyup="checkEmptyForLeader()" 
									required name="vehicleVo.leaderName" value="${vehicleVo.leaderName}" maxLength="50">
									<input type="hidden" name="vehicleVo.leaderId" value="${vehicleVo.leaderId}">
								</td>
							</tr>
						</tbody>
						<tbody id="insuranceRecord">
							...
							<tr>
								...
								<td>保额<span style="color:red"> *</span></td>
							...
							<c:forEach items="${vehicleVo.insuranceRecordVo.time}" varStatus="status">
								<tr>
								<td>
									<input type="text" autocomplete="off" class="form-control" name="insuranceRecord.time" value="${vehicleVo.insuranceRecordVo.time[status.index]}" required
								...
								<td>
									<input autoComplete="off" required onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9/.]+/,'');}).call(this)" onblur="this.v();"
			  						class="form-control" name="insuranceRecord.money" value="${vehicleVo.insuranceRecordVo.money[status.index]}">
								</td>
								<td>
									<input type="text" autocomplete="off" class="form-control" name="insuranceRecord.nextInsuranceTime" required
	    			 				onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd', minDate:'%y-%M-%d' })" value="${vehicleVo.insuranceRecordVo.nextInsuranceTime[status.index]}"/>
								</td>
								<td>
						...
						<tbody id="yearlyInspection">
							...
							<c:forEach items="${vehicleVo.yearlyInspectionVo.time}" varStatus="status">
								...
								<td>
									...
									onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd', maxDate:'%y-%M-%d'})" value="${vehicleVo.yearlyInspectionVo.time[status.index]}"/>
								</td>
								<td colspan="2">
									<input type="text" autocomplete="off" class="form-control" name="yearlyInspectionVo.nextYearlyInspectionTime" required
										onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd', minDate:'%y-%M-%d' })" value="${vehicleVo.yearlyInspectionVo.nextYearlyInspectionTime[status.index]}"/>
								</td>
								<td>
						...
						<tbody id="maintainRecord">
							...
							<tr>
								...
								<td>保养费用<span style="color:red"> *</span></td>
								<td>操作</td>
							</tr>
							<c:forEach items="${vehicleVo.maintainRecordVo.time}" varStatus="status">
								...
								<td>
	    							...
	    							onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd', maxDate:'%y-%M-%d'})" value="${vehicleVo.maintainRecordVo.time[status.index]}"/>
								</td>
								<td>
									<input autoComplete="off" required onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9/.]+/,'');}).call(this)" onblur="this.v();"
			  						class="form-control" name="maintainRecord.maintainMileages" value="${vehicleVo.maintainRecordVo.maintainMileages[status.index]}">
								</td>
								<td>
									<input autoComplete="off" required onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9/.]+/,'');}).call(this)" onblur="this.v();"
			  						class="form-control" name="maintainRecord.maintainMoney" value="${vehicleVo.maintainRecordVo.maintainMoney[status.index]}">
								</td>
								<td>
						...
						<tbody id="repairRecord">
							...
							<tr>
								...
								<td>维修金额<span style="color:red"> *</span></td>
								<td>操作</td>
							</tr>
							<c:forEach items="${vehicleVo.repairRecordVo.time}" varStatus="status">
								...
								<td>
	    							...
	    							onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd', maxDate:'%y-%M-%d'})" value="${vehicleVo.repairRecordVo.time[status.index]}"/>
								</td>
								<td>
									<input type="text" autocomplete="off" class="form-control" name="repairRecord.repairItems" required maxLength="100" value="${vehicleVo.repairRecordVo.repairItems[status.index]}"/>
								</td>
								<td>
									<input autoComplete="off" required onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9/.]+/,'');}).call(this)" onblur="this.v();"
			  						class="form-control" name="repairRecord.repairMoney" value="${vehicleVo.repairRecordVo.repairMoney[status.index]}">
								</td>
								<td>
						...
						<tbody id="vehicleUseRecord">
							...
							<c:forEach items="${vehicleVo.vehicleUseRecordVo.time}" varStatus="status">
								...
								<td>
	    							...
	    							onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd', maxDate:'%y-%M-%d'})" value="${vehicleVo.vehicleUseRecordVo.time[status.index]}"/>
								</td>
								<td>
									<input type="text" autocomplete="off" class="form-control" name="vehicleUseRecord.reason" required maxLength="100" value="${vehicleVo.vehicleUseRecordVo.reason[status.index]}"/>
								</td>
								<td>
									<input class="form-control vehicleUser" type="text" autocomplete="off" onkeyup="checkEmptyForUse(this)" required name="vehicleUseRecord.userName" value="${vehicleVo.vehicleUseRecordVo.userName[status.index]}" maxLength="50">
									<input type="hidden" name="vehicleUseRecord.userId" value="${vehicleVo.vehicleUseRecordVo.userId[status.index]}">
								</td>
								<td>
