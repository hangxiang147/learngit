  ...
  <body>
    <div class="container-fluid">
      <div class="row">
        ...
        <h3 class="sub-header" style="margin-top:0px;">项目列表</h3>
       	<form action="administration/project/findAllProjectList" class="form-horizontal" onsubmit="Load.Base.LoadingPic.FullScreenShow(null)">
        	<div class="form-group">
        		<label class="control-label col-sm-1">发起时间</label>
        		<div class="col-sm-2">
              		  ...
              		  <tbody>
		              	...
		              	<c:forEach items="${projectInfoVos}" var="item" varStatus="index">
		              		<tr>
			              		...
			              		<td>
			              		<a onclick="goPath('administration/project/processHistory?processInstanceID=${item.processInstanceID}&selectedPanel=allProjectList')" href="javascript:void(0)">
			              			<svg class="icon" aria-hidden="true" title="查看流程详情" data-toggle="tooltip">
             							<use xlink:href="#icon-liucheng"></use>
             						</svg>
			              		</a>
			              		&nbsp;
			              		<a onclick="goPath('administration/project/showProjectDetail?processInstanceID=${item.processInstanceID}&selectedPanel=allProjectList')" href="javascript:void(0)">
			              			<svg class="icon" aria-hidden="true" title="查看项目详情" data-toggle="tooltip">
             							<use xlink:href="#icon-Detailedinquiry"></use>
             						</svg>
			              		</a>
			              		&nbsp;
			              		<a onclick="goPath('administration/project/showProjectProcess?processInstanceID=${item.processInstanceID}&selectedPanel=allProjectList')" href="javascript:void(0)">
