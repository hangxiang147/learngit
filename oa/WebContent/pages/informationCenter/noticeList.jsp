...
<body>
	<div class="container-fluid">
      <div class="row">
        ...
        <h3 class="sub-header" style="margin-top:0px;">公告</h3>
<%--        	<a class="btn btn-primary" href="information/notice/noticeAdd"><span class="glyphicon glyphicon-plus"></span> 公告信息</a> --%>
         <c:if test="${not empty noticeList}">
         <div class="message">
         <ul>
         <s:iterator id="notice" value="#request.noticeList" status="count">
                 <li ><a class="ntcTit" href="javascript:void(0)" onclick="getNotice(<s:property value='#notice.ntcID'/>)"><s:if test="#notice.isTop==1">【置顶】</s:if><s:property value="#notice.ntcTitle"/></a>
                 <span><s:property value="#notice.noticeDate"/></span></li>
         	</s:iterator>
         	</ul>
         	</div>
         </c:if>
