...
<script type="text/javascript">
	...
	function selectCompany(){
		...
		location.href = "HRCenter/showStaffsInJobAnalysis?companyId="+companyId;
...
<body>
	...
	<div class="row">
		...
		<h3 class="sub-header" style="margin-top:0px;">在职员工分析</h3>
		...
		<div class="chartTitle" style="margin:1% 0">在职人员部门结构</div>
