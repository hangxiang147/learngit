	...
	<div class="container-fluid">
      <div class="row">
       ...
       <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <form  id="form_" class="form-horizontal" action="/personal/newCertificateBorrow" onsubmit="Load.Base.LoadingPic.FullScreenShow(null)">     	  
            ...
            <table class="table table-striped">
              ...
              <tbody>
              	...
              	<c:forEach items="${certificates}" var="certificate" varStatus="index">
              		...
              		<td>${certificate.subject_personName}</td>
              		<td>${certificate.store_personName}</td>
              		<td>
            			<input class="btn btn-primary" value="申请证件" onClick="new_task_for_CertificateBorrow('${certificate.id}')" style="width:100px"/>
            			<input class="btn btn-primary" value="查看附件" onClick="showAttachment('${certificate.id}')" style="width:100px"/>
              		</td>
              		</tr>
              	</c:forEach>
              	</c:if>
         ...
         var new_task_for_CertificateBorrow=function (id){
        	 location.href="/personal/toBeginCertificateBorrowPage?id="+id;
