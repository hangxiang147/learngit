        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	<form action="personal/save_startContractBorrow" method="post"  id="form_"class="form-horizontal" onsubmit="Load.Base.LoadingPic.FullScreenShow(null)">  
			  ...
			  <div class="form-group">
			  	<label for="reason" class="col-sm-1 control-label" style="width:10%">合同名称</label>
			  ...
			  <div class="form-group">
			  	...
			  	<div class="col-sm-5"><input type="text" autoComplete="off" class="form-control" name="contractBorrowVo.reason" required></div>
			  </div>
