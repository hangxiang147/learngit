	...
	<div class="container-fluid">
      <div class="row">
       ...
       <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <form  id="form_" class="form-horizontal" action="/personal/newTransferProperty">   
            ...
            <table class="table table-striped">
              ...
              <tbody>
              	...
              	<s:iterator id="asset" value="#request.assetList" status="count">
              		<tr>
              			<td class="col-sm-1">
              			<a  onclick="goPath('personal/toBeginTransferPropertyPage?assetName=${asset.assetName}&assetNum=${asset.serialNumber}&model=${asset.model}&recipientId=${asset.assetUsageVO.recipientID}&assetType=<s:if test="#asset.type==1">行政办公设备</s:if><s:if test="#asset.type==2">电子产品</s:if><s:if test="#asset.type==3">通信设备</s:if><s:if test="#asset.type==4">交通工具</s:if>&oldCompany=${asset.assetUsageVO.companyName}&assetId=${asset.assetID}')"
              			href="javascript:void(0)">
              			<svg class="icon" aria-hidden="true" title="资产调拨" data-toggle="tooltip">
