...
<script type="text/javascript">
	...
	function search() {
		...
		window.location.href = "/finance/process/findPaymentListAll?" + params;
              ...
              <tbody>
              	...
              	<s:iterator id="taskVO" value="#request.taskVOs" status="count">
              		<tr>
              			...
              			<td class="col-sm-1">
              			<a onclick="goPath('finance/process/auditPayment?taskID=<s:property value='#taskVO.taskID' />&selectedPanel=reimbursementList&isFromAll=1&taskName=<s:property value="#taskVO.taskName"/>')" href="javascript:void(0)">
