    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       	  <h3 class="sub-header" style="margin-top:0px;">背景审核列表</h3>
              ...
              <tbody>
              	...
              	<s:iterator id="taskVO" value="#request.taskVOs" status="count">
              		<tr>
              			...
              			<td class="col-sm-2"><s:property value="#taskVO.auditUserName" /></td>
              			...
              			<td class="col-sm-1">
              			<a onclick="goPath('HR/process/auditBackground?taskID=<s:property value='#taskVO.taskID' />')" href="javascript:void(0)">
