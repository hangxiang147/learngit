...
<body>
	<div class="container-fluid">
      <div class="row">
      	...
      	<c:if test="${selectedPanel=='salaryAlteration'}">
      		 <%@include file="/pages/HR/panel.jsp" %>
      	</c:if>
      	<c:if test="${selectedPanel=='changeStaffSalaryList' || selectedPanel=='applyPaySalaryList'}">
      		 <%@include file="/pages/attendance/salayPanel.jsp" %>
      	</c:if>
      	<c:if test="${selectedPanel=='rewardAndPunishmentList'}">
