  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row"> 
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <form  id="form_" class="form-horizontal" action="administration/contractManage/showContracts" onsubmit="Load.Base.LoadingPic.FullScreenShow(null)">     	  
           ...
           <a class="btn btn-primary"  onclick="goPath('/administration/contractManage/toEditContract')" href="javascript:void(0)"><span class="glyphicon glyphicon-plus"></span> 合同信息</a>
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
              	<c:if test="${not empty contractLst}">
              	<c:forEach items="${contractLst}" var="item" varStatus="index">
              		<tr>
    ...
    var fn_delete=function(id){
		layer.open({  
            ...
            yes: function(index) {  
            	layer.close(index);
  	    		window.location.href='/administration/contractManage/deleteContract?contractId='+id; 
  	    		Load.Base.LoadingPic.FullScreenShow(null);
            }
        }); 
    }
    var fn_toUpdate =function(id){
    	location.href="administration/contractManage/toEditContract?contractId="+id;
    	Load.Base.LoadingPic.FullScreenShow(null);
    }
    var fn_log=function(id){ 
    	location.href="administration/contractManage/toContractUseLog?contractId="+id;
    	Load.Base.LoadingPic.FullScreenShow(null);
    }
