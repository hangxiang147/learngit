        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <form  id="sendExpressForm" class="form-horizontal">
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-2">
			    	<input type="text" class="form-control" id="endDate" name="noticeVO.endTime" value="${noticeVO.endTime }" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="结束时间">
			    </div>
			</div>
			<div class="form-group">
			<label for="myType" class="col-sm-1 control-label">是否置顶</label>
			<div class="col-sm-2">						
			<select class="form-control" id="myType" name="noticeVO.isTop" >
		      <option value="">请选择</option>
		      <option value="0" <s:if test="#request.noticeVO.isTop == 0 ">selected="selected"</s:if> >否</option>
		      <option value="1" <s:if test="#request.noticeVO.isTop == 1 ">selected="selected"</s:if> >是</option>
			</select>
			</div>
			</div>
			<div class="col-sm-5">
          ...
          <a class="btn btn-primary"  onclick="goPath('pages/administration/newNotice.jsp?selectedPanel=noticeList')" href="javascript:void(0)">新增公告</a>
            ...
            <table class="table table-striped">
              <thead>
                <tr>
                  ...
                  <th class="col-sm-1">是否置顶</th>
                  <th class="col-sm-1">置顶开始时间</th>
                  <th class="col-sm-1">置顶结束时间</th>
              ...
              <tbody>
              	...
              	<s:iterator id="notice" value="#request.noticeList" status="count">
              		<tr>
              			...
              			<td class="col-sm-1"><s:if test="#notice.isTop==0">否</s:if><s:if test="#notice.isTop==1">是</s:if></td>              			
              			<td class="col-sm-1"><s:property value="#notice.topStartTime"/></td>              			
              			<td class="col-sm-1"><s:property value="#notice.topEndTime"/></td>              			
              			<td class="col-sm-1">
						...
						<use xlink:href="#icon-delete"></use>
              			...
              			&nbsp;
              			<a href="javascript:void(0)" onclick="goPath('administration/notice/modifyNotice?type=2&notId=<s:property value='#notice.ntcID'/>')">
