  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
      	...
      	<s:set name="selectedPanel" value="'toVitaeStep2'"></s:set>
        <%@include file="/pages/HR/vitae/panel.jsp" %>	
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <form id="queryReimbursementForm" class="form-horizontal">
       	  <h3 class="sub-header" style="margin-top:0px;">完善人员信息待办列表</h3>
              ...
              <tbody>
              	...
              	<s:iterator id="taskVO" value="#request.taskVOs" status="count">
              		<tr>
              			...
              			<td class="col-sm-1">
              			<a href="/HR/vitae/editSignTableByEmployee?taskID=<s:property value='#taskVO.taskID'/>&resultId=<s:property value="#taskVO.vitaeResultId"/>&vitaeSignId=<s:property value="#taskVO.vitaeSignId"/>">填写信息</a>
