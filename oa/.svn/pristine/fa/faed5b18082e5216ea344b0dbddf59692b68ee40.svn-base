    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <form id="queryReimbursementForm" class="form-horizontal">
       	  <h3 class="sub-header" style="margin-top:0px;">发起应聘待办列表</h3>
              ...
              <tbody>
              	...
              	<s:iterator id="taskVO" value="#request.taskVOs" status="count">
              		<tr>
              			...
              			<td class="col-sm-1">
              			<a onclick="goPath('/HR/vitae/toStartVitaePage?taskID=<s:property value='#taskVO.taskID' />&selectedPanel=reimbursementList&taskName=<s:property value="#taskVO.taskName"/>')" href="javascript:void(0)">
              				<svg class="icon" aria-hidden="true" title="发起邀请" data-toggle="tooltip">
