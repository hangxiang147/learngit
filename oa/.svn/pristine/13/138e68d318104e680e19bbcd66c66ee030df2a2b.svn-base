    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<h3 class="sub-header" style="margin-top:0px;">报销申请列表</h3>
	                ...
	                <tr>
	              	...
	              	<s:iterator id="reimbursementVO" value="#request.reimbursementVOs" status="count">
	              		<tr>
	              			...
	              			<td class="col-sm-1"><a onclick="goPath('finance/process/processHistory?processInstanceID=<s:property value='#reimbursementVO.processInstanceID'/>')" href="javascript:void(0)"><s:property value="#reimbursementVO.title"/></a></td>
	              			...
	              			<td class="col-sm-1">
	              			<a onclick="goPath('finance/reimbursement/getReimbursementDetail?type=5&processInstanceID=<s:property value='#reimbursementVO.processInstanceID'/>&selectedPanel=myReimbursementList')" href="javascript:void(0)">
	              			<svg class="icon" aria-hidden="true" title="查看详情" data-toggle="tooltip">
								<use xlink:href="#icon-Detailedinquiry"></use>
							</svg>
	              			</a>
	              			<s:if test="#reimbursementVO.status=='未通过' && #reimbursementVO.reStart!=1">
	              			&nbsp;
	              			<a onclick="goPath('finance/process/reNewReimbursement?processInstanceID=<s:property value='#reimbursementVO.processInstanceID'/>')" href="javascript:void(0)">
	              			<svg class="icon" aria-hidden="true" title="重新发起申请" data-toggle="tooltip">
      ...
      $('table tr:gt(0)').each(function (){
    		...
    		console.log(content)
    	 	if(content){
    	 		...
    	 		if('未通过'==content)
    	 			$(this).find("td:eq(8)").find("a").css("display","block");
    	 	}
      })
      </script> --%>
  </body>
