  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row"> 
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <form  id="form_" class="form-horizontal" action="administration/chop/toChopListPage" onsubmit="Load.Base.LoadingPic.FullScreenShow(null)">     	  
          	<h3 class="sub-header" style="margin-top:0px;">公章信息管理</h3> 
           ...
           <a class="btn btn-primary" onclick="goPath('administration/chop/toChopAddPage')" href="javascript:void(0)"><span class="glyphicon glyphicon-plus"></span> 公章信息</a>
              ...
              <tbody>
              	...
              	<c:forEach items="${chops}" var="item" varStatus="index">
            		...
            		<td><c:if test="${item.type=='1'}">
              		...
              		<td>
              			<a onClick="fn_toUpdate('${item.chop_Id}')" href="javascript:void(0)">
              				<svg class="icon" aria-hidden="true" title="编辑" data-toggle="tooltip">
								<use xlink:href="#icon-modify"></use>
						</svg>
              			</a>
              			&nbsp;
              			<a onClick="fn_delete('${item.chop_Id}')" href="javascript:void(0)">
              				<svg class="icon" aria-hidden="true" title="删除" data-toggle="tooltip">
								<use xlink:href="#icon-delete"></use>
						</svg>
              			</a>
              			&nbsp;
              			<a onClick="fn_log('${item.chop_Id}')" href="javascript:void(0)">
    ...
    var fn_delete=function(id){
    	layer.open({  
            ...
            yes: function(index) {  
            	layer.close(index);
  	    		window.location.href='/administration/chop/chopDelete?id='+id; 
