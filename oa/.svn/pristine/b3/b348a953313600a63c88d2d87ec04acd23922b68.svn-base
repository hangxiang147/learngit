	...
	<div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	<form action="administration/process/save_startEmail" method="post" class="form-horizontal" onsubmit="return check()">
        	  <s:token></s:token>
        	  <h3 class="sub-header" style="margin-top:0px;">公司邮箱申请</h3> 
        	  <!-- 填写邮箱申请的操作人 -->
			  <input type="hidden" id="userID" name="emailVO.userID" value="${user.id}"/>
			  <input type="hidden" id="userName" name="emailVO.userName" value="${staff.lastName }" />
			  <!-- 邮箱申请人 -->
			  <input type="hidden" id="requestUserID" name="emailVO.requestUserID" value="${user.id }"/>
   			  <input type="hidden" id="requestUserName" name="emailVO.requestUserName" value="${staff.lastName }"/>
			  <div class="form-group" id="executor_div">
			  	<label for="executor" class="col-sm-1 control-label">邮箱申请人</label>
			  ...
			  <div class="form-group">
			  	<label for="address" class="col-sm-1 control-label">邮箱地址<span style="color:red"> *</span></label>
			  	<div class="col-sm-2"><input type="text" class="form-control" id="address" required="required" /></div>
			  	<strong style="float:left;padding-top:8px;font-family:verdana,sans-serif">@</strong>
			  	<div class="col-sm-2">
			    	<select class="form-control" id="emailType" required="required">
				      <option value="">请选择</option>
					  <option value="zhizaolian.com">zhizaolian.com</option>
					  <option value="irisie.com">irisie.com</option>
					</select>
			    </div>
			    <input type="hidden" id="emailAddress" name="emailVO.address" />
			  </div>
			  <div class="form-group">
			  	<label for="reason" class="col-sm-1 control-label">申请原因<span style="color:red"> *</span></label>
			  	<div class="col-sm-5"><input type="text" class="form-control" id="reason" name="emailVO.reason" required="required" /></div>
			  </div>
			  <div class="form-group">
