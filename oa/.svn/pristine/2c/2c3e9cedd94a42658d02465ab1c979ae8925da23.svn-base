      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	<form action="HR/vitae/save_saveJob" method="post"  id="form_"class="form-horizontal">  
        	  <s:token></s:token>
        	  <h3 class="sub-header" style="margin-top:0px;">职位信息编辑</h3> 			 
			  ...
			  <div class="form-group">
			  	...
			  	<div class="col-sm-2"><input type="text" class="form-control"  autocomplete="off"  value="${jobEntity.jobName }" name="jobEntity.jobName" required="required" ></div>
			  </div>
			  <div class="form-group">
			  	<label for="reason" class="col-sm-1 control-label">职位描述</label>
			  	<div class="col-sm-7"><textarea name="jobEntity.jobDescription" data-provide="markdown" rows='7' >${jobEntity.jobDescription}</textarea></div>
			  </div>
			  <div class="form-group">
