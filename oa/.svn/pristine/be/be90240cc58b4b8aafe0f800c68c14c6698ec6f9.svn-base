...
<div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	<form action="/administration/public/save_advicePublicEvent" class="form-horizontal" onsubmit="Load.Base.LoadingPic.FullScreenShow(null)">  
        	  <s:token></s:token>
			  ...
			  <div class="form-group">
			  	<label class="col-sm-1 control-label" style="width:13%">处理人：</label>
			  	<div class="col-sm-1 control-label" style="text-align:left">
			  		${handlerInfo.staffName}
			  	</div>
			  	<label class="col-sm-1 control-label" style="width:7%">电话：</label>
			  	<div class="col-sm-1 control-label" style="text-align:left">
			  		${handlerInfo.telephone}
			  	</div>
			  	<label class="col-sm-1 control-label" style="width:13%">处理完成时间：</label>
			  	<div class="col-sm-2 control-label" style="text-align:left">
			  		${completeHandleTime}
			  	</div>
			  </div>
			  ...
			  <div class="form-group">
			  	<label class="col-sm-1 control-label" style="width:13%">意见反馈<span style="color:red"> *</span></label>
			  	<div class="col-sm-5">
