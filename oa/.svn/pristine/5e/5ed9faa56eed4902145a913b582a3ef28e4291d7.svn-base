	...
	<div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	<form  action="HR/contract/saveRenewContract"  method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return check();">
        	
        	  <s:token></s:token>
        	  <h3 class="sub-header" style="margin-top:0px;">合同续签</h3>
			  ...
			  <div class="form-group" >
			  	...
			  	<input type="hidden" name="contractVO.partyB" value="${contractVO.partyB }"/>
			  </div>
			  <div class="form-group" >
