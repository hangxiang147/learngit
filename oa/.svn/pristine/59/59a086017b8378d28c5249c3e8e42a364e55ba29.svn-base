        	 ...
        	 <div id="printArea">
		   	 ...
		   	 <div class="tab" style="width:80%;text-align:center;margin:auto">
	       	  ...
	       	  <div style="margin-left:10%;margin-top:2%">
		       	  	...
		       	  	<button type="button" class="btn btn-primary" style="margin-left:5%" onclick="goPath('personal/toBeginChopBorrowPage?id=7&processInstanceId=${brandAuth.processInstanceID}&fileName=品牌授权申请&fileUse=品牌授权')">申请公章</button>
