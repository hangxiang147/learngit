...
<style type="text/css">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
      	<s:set name="selectedPanel" value="'softPerformanceSubjectSS'"></s:set>
        <%@include file="/pages/performance/soft/subject/panel.jsp" %>	
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <form  class="form-horizontal" >
          	<h3 class="sub-header" style="margin-top:0px;">实施人员结果填写</h3>
          </form>
              	...
              	<c:if test="${not empty resultList}">
		              	...
		              	<s:iterator id="taskVO" value="#request.resultList" status="count">
		              		<tr>
		              			...
		              			<svg class="icon" aria-hidden="true" title="填写实施结果" data-toggle="tooltip">
