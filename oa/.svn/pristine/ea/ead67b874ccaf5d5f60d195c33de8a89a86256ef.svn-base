    ...
    <div class="container-fluid">
      <div class="row"> 
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <form  id="form_" class="form-horizontal" action="/HR/vitae/toSignList">     	  
          	<h3 class="sub-header" style="margin-top:0px;">应聘登记信息查询</h3> 
            ...
            <table class="table table-striped">
              ...
              <tbody>
              	...
              	<c:forEach items="${resultList}" var="item" varStatus="index">
              		...
              		<td>${item.xm }</td>
              		<td>${item.lxfs }</td>
              		<td><a href="javascript:location.href='/HR/vitae/toViewSignDetail?vitaeSignId=${item.id}'">查看</a></td>
              		</tr>
              	</c:forEach>
              	</c:if>
              </tbody>
